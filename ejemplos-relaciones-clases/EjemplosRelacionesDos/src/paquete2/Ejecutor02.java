...
public class Ejecutor02 {
    ...
    public static void main(String[] args) {
        ...
        Ciudad ciudad3= new Ciudad("Cuenca");
        Barrio barrio1 = new Barrio("San Sebastián", ciudad1);
        Barrio barrio2 = new Barrio("Sucre", ciudad2);
        Barrio barrio3=new Barrio("Platiado",ciudad3);
        Persona persona1 = new Persona("René Elizalde", "1100909909", barrio1);
        Persona persona2 = new Persona("Omer Benitez", "19500909909", barrio2);
        Persona persona3 = new Persona("Luis Sarango", "1750909909", barrio3);
        System.out.println("------------------------------------------");
